...
# MODIFIED - load data from inputs/ directory
...
# MODIFIED - write solution to outputs/solutions directory
with open("outputs/solutions/result_highs.txt", "w") as f:
...
# MODIFIED - write solution to outputs/solutions directory
with open("outputs/solutions/result_gurobi.txt", "w") as f:
