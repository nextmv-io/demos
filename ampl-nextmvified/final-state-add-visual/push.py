...
if app.instance_exists("staging-viz"):
    app.update_instance(version_id=version_id, id="staging-viz", name="staging-viz")
else:
    app.new_instance(version_id=version_id, id="staging-viz", name="staging-viz")
